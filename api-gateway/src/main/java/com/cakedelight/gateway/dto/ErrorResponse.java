package com.cakedelight.gateway.dto;
 ...
 * component keeps its own copy of this record; there is no shared library between components.
 *
 * @param code      stable machine readable error code, for example {@code ROUTE_NOT_FOUND}
