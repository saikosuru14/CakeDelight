...
import com.cakedelight.notification.dto.ErrorResponse;

import jakarta.servlet.http.HttpServletRequest;

/**
 * The single error rendering point for the Notification Service (Requirements 8.5, 12.1, 12.2, 12.3).
 *
...
public class GlobalExceptionHandler {
     ...
     * example a malformed UUID in {@code /api/notifications/orders/{orderId}}
     * (Requirements 8.5, 12.1).
     */
